...
# [TASK-0012] — Establish durable refund and append-only ledger model

## Status

`Blocked` pending roadmap PR 03 merge and PLAN-0011 rebase/readiness.
...
PR 03 is merged; PLAN-0011 is rebased to that main SHA and transitioned to Ready without source-Spec changes.
...
- Stop if PR 03 is not merged or PLAN-0011 is still Draft.
...
- 2026-09-08 — v1 — Blocked task created after human approval of refund semantics.
