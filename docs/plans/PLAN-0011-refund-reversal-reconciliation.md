...
`Ready`. The source Specification is Accepted and roadmap PR 03 security hardening merged into the baseline. TASK-0012 is now executable; TASK-0013 and TASK-0014 remain dependency-blocked.
