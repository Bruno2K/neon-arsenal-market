...
// AUD-005 (PR11): commissionRate is intentionally not accepted here. It has no
// caller-controlled write path anywhere in the current API; new sellers get the
// database default (`Seller.commissionRate @default(0.1)` in schema.prisma). A
// dedicated admin commission-management capability is frozen backlog, not PR11.
