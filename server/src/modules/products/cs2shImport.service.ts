...
import { isCs2ShConfigured, isCs2ShImportEnabled } from "../../shared/config/cs2sh.js";
...
async function runCs2ShCatalogImport(client: Cs2ShClient): Promise<Cs2ShImportSummary> {
  ...
  const summary: Cs2ShImportSummary = {
    ...
    // Kept temporarily for response compatibility. Catalog imports never create offers.
    listingsUpserted: 0,
  };
