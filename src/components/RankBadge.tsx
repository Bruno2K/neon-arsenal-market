// ─── Component: RankBadge ─────────────────────────────────────────────────────
// Standalone component — type is defined locally, no mock-data dependency.
// Kept for future use when seller rank tiers are implemented in the real API.
...
export function RankBadge({
  ...
  return (
    <span
      className={`inline-flex items-center rounded border font-heading ${c.className} ${sizeClass}`}
    >
