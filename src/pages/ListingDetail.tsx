      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="text-center relative z-10">
            <span className="text-4xl font-heading text-foreground/70 block">
              {productName}
            </span>
        ...
        >
          <div>
            <h1 className="text-3xl font-heading text-foreground mt-3 normal-case">
              {productName}
            </h1>
            <div className="mt-3 space-y-2">
              <div className="flex items-center gap-4 text-sm text-muted-foreground">
                <span>
                  <strong className="text-foreground">Raridade:</strong>{" "}
                  {listing.product.rarity}
                </span>
                <span>
                  <strong className="text-foreground">Coleção:</strong>{" "}
                  {listing.product.collection || "N/A"}
                </span>
              </div>
              <div className="flex items-center gap-4 text-sm">
                <span className="text-muted-foreground">
                  <strong className="text-foreground">Float:</strong>{" "}
              ...
              {listing.tradeLockUntil && (
                <div className="text-sm text-muted-foreground">
                  <strong className="text-foreground">Trade Lock até:</strong>{" "}
            ...
            {priceHistory && priceHistory.length > 0 && (
              <div className="text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Última alteração: ${priceHistory[0].newPrice.toFixed(2)}
                  </span>
                </div>
              </div>
            )}
